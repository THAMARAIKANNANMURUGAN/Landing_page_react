        ...
        <>
            <section className="showcase">
                <div className="container-fluid p-0">
                    <div id='cont_row' className="row g-0">
                        <div className="col-lg-6 order-lg-2 text-white showcase-img" ><Image className='image_box' src={two}></Image></div>
                        <div id='tex_contain'  className="col-lg-6 order-lg-1 my-auto showcase-text">
                    ...
                    <div className="row g-0">
                        <div className="col-lg-6 text-white showcase-img" ><Image className='image_box' src={three}></Image></div>
                        <div id='tex_contain'    className="col-lg-6 my-auto showcase-text">
                    ...
                    <div className="row g-0">
                        <div className="col-lg-6 order-lg-2 text-white showcase-img"><Image className='image_box' src={four}></Image></div>
                        <div id='tex_contain'  className="col-lg-6 order-lg-1 my-auto showcase-text">
